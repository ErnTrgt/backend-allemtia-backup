...
<head>
    ...
    <title>Fatura #{{ $order->order_number }} - Satıcı</title>
    <style>
        body {
...
<body>
    ...
    <div class="seller-info">
        ...
        <div><strong>Ad:</strong> {{ auth()->user()->name }}</div>
        <div><strong>E-posta:</strong> {{ auth()->user()->email }}</div>
        <div><strong>Telefon:</strong> {{ auth()->user()->phone ?? 'Belirtilmemiş' }}</div>
    </div>
    ...
    <div class="notes">
        <p><strong>Not:</strong> Bu fatura sadece satıcıya ait ürünleri içerir ve elektronik ortamda oluşturulmuştur.</p>
